        ...
        <ul className="faq-list">
          ...
          <li>
            ...
            <div id="faq3" className="collapse" data-bs-parent=".faq-list">
              <p>
                Step 1: Open an Account with our MR distributors.<br/>
                Step 2: read the prospectus carefully which contains (investor objectives, risks, Fee table, and  shareholder information)<br/>
