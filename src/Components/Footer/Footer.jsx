        ...
        <div className="inner-contain">
          <Row>
            ...
            <Col className="foot-col col-12 col-md-6 col-lg-3 text-md-left">
              ...
              <ul>
                <li>
                  <a className="foot-links" href="#hero">
                    Home
                  </a>
                </li>
                <li>
            ...
            <Col className="foot-col col-12 col-md-6 col-lg-3" id="co">
              <h6 className="mt-5 foot-link-head-1">GuideLines</h6>
              <ul>
                <li>
                  <a
                    className="foot-imp-links"
                    href="/"
            ...
            <Modal.Body>
              ...
              {modalContent === "Disclaimer" && (
                <p style={{ color: "black" }}>
                  ...
                  uninterrupted, secure, or error, or that this site, its
                  server, or any files available for downloading through this
                  site are free of computer viruses or other harmful elements.
                  <br></br>
                  The MR distributions have no responsibility for viruses or any
                  other damage that may be caused to you as a result of using
                  this site.<br></br>
                  ...
                  accuracy, or completeness of the site is assumed solely by
                  you.<br></br>
